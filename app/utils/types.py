...
class RFSchema(pa.DataFrameModel):
    """
    Class for handling options data for risk free yields
    """

    Maturity: Series[float] = pa.Field(ge=0)
    Yield: Series[float] = pa.Field()  # Ensures 'k' is a float column
